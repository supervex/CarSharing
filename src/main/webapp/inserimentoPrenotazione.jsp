	...
	<div class="row">
		...
		<div class="col-md-6 mb-4 d-flex justify-content-center">
			<div class="card p-4" style="width: 100%; max-width: 500px;">
				...
				<form method="get" action="NoleggioController" class="mx-auto"
					style="max-width: 300px;">
					<input type="hidden" name="idAuto" value="<%=auto.getId()%>">
					<div class="mb-3">
						<label for="data-ritiro" class="form-label">📅 Data di
							ritiro</label> <input type="date" name="dataRitiro" id="data-ritiro"
							class="form-control"
							value="<%=(dataRitiro != null) ? dataRitiro : ""%>">
					</div>
					<div class="mb-3">
						<label for="ora-ritiro" class="form-label">🕒 Ora di
							ritiro</label> <input type="time" name="oraRitiro" id="ora-ritiro"
							class="form-control"
							value="<%=(oraRitiro != null) ? oraRitiro : ""%>">
					</div>
					<div class="mb-3">
						<label for="data-riconsegna" class="form-label">📅 Data di
							riconsegna</label> <input type="date" name="dataRiconsegna"
							id="data-riconsegna" class="form-control"
							value="<%=(dataRiconsegna != null) ? dataRiconsegna : ""%>">
					</div>
					<div class="mb-3">
						<label for="ora-riconsegna" class="form-label">🕒 Ora di
							riconsegna</label> <input type="time" name="oraRiconsegna"
							id="ora-riconsegna" class="form-control"
							value="<%=(oraRiconsegna != null) ? oraRiconsegna : ""%>">
					</div>
					<input type="hidden" name="tipoOperazione" value="preparaPagamento">
					<button type="submit" class="btn btn-primary w-100">Vai al
						pagamento</button>
				</form>
			</div>
		</div>
			...
			<div class="col-md-8 mx-auto">
				...
				<div class="card mb-3">
					<div class="card-body text-center">
						<h5 class="card-title">
							Utente:
							<%=utente.getNome() + " " + utente.getCognome()%></h5>
						<p class="card-text">
							Valutazione:
							<%=recensione.getValuatzione()%>/5
						</p>
				...
				%>
				<div class="alert alert-secondary text-center">Non ci sono
					ancora recensioni per questa auto.</div>
				<%
				}
				%>
			</div>
